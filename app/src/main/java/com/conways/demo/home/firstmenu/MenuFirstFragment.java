...
import com.conways.demo.home.firstmenu.bigsizeImage.BigImageActivity;
...
import com.conways.demo.home.firstmenu.linechart.LineChartActivity;
...
public class MenuFirstFragment extends BaseFragment implements View.OnClickListener, OnItemClickLisener {
    ...
    private Class<?>[] listTarget = {BloodPressureActivity.class, TimeWheelActivity.class,
            ...
            .class, RetrofitActivity.class, LineChartActivity.class};

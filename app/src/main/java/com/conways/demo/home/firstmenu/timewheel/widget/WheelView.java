 ...
 */
package com.conways.demo.home.firstmenu.timewheel.widget;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    private float mExtraTextSize; // 附加文本大小
    private float mExtraMargin;   // 附加文本外边距
     ...
     * @param margin
     */
    public void setExtraText(String text, int textColor, float textSize, float
            margin) {
        mExtraText = text;
    ...
    public static class WheelViewStyle {
        ...
        public float textSize = -1;// 文本大小
        public float selectedTextSize = -1;   // 选中文本大小

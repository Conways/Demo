...
import com.conways.demo.home.firstmenu.OnItemClickLisener;
...
public class MyAdapter extends RecyclerView.Adapter<MyHolder> {
    ...
    public MyHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_menu_2_recycler_view, viewGroup, false);
